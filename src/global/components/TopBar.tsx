...
const PROJECT_ROUTES = [
  ...
  },
  {
    ...
    path: "/",
    icon: <IoMdAddCircleOutline className="size-6" />,
  },
  { label: "Cart", path: "/", icon: <TiShoppingCart className="size-6" /> },
];

export function TopBar() {
  return (
    <div className="TopBar relative flex h-20 px-4 w-full bg-black items-center justify-between">
        ...
        {PROJECT_ROUTES.map((route, index) => (
          <div className="flex items-center justify-center" key={index}>
            ...
            >
              ...
              <h2 className="mr-4 text-blue-600 hover:underline">
                {route.label}
              </h2>
            </Link>
          </div>
